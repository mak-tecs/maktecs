...
export const createCheckoutAndGetURL = async ({ uid, products, orderDetails }) => {
        ...
        product_data: {
          ...
          images: [
            item?.product?.featureImageURL ??
              `${process.env.NEXT_PUBLIC_DOMAIN}/logos/Horizontal.svg`,
          ],
          metadata: {
            productId: item?.id,
          },
  ...
  await setDoc(ref, {
    ...
    metadata: {
      ...
      uid: uid,
      address: JSON.stringify(orderDetails),
    },
...
export const createCheckoutCODAndGetId = async ({ uid, products, orderDetails }) => {
